                ...
                <Tabs defaultValue="one" className="h-full space-y-6">
                    <div className="space-between flex items-center">
                        <TabsList>
                            ...
                            <TabsTrigger value="educations" className="relative">   Educations </TabsTrigger>
                    ...
                    <TabsContent value="educations" className="border-none p-0 outline-none"><EditOneTab /> </TabsContent>
